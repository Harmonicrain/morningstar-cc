...
public class PluginManager {
    ...
    private void registerDefaultEvents() {
        try {
            ...
            this.methods.add(QuestEventListener.class.getMethod("onUserSavedMottoEvent", UserSavedMottoEvent.class));
            this.methods.add(QuestEventListener.class.getMethod("onUserSavedLookEvent", UserSavedLookEvent.class));
            this.methods.add(QuestEventListener.class.getMethod("onUserReceiveHandItemEvent", UserReceiveHandItemEvent.class));
            this.methods.add(QuestEventListener.class.getMethod("onFurnitureToggleEvent", FurnitureToggleEvent.class));
            this.methods.add(QuestEventListener.class.getMethod("onUserEnterRoomEvent", UserEnterRoomEvent.class));
            this.methods.add(QuestEventListener.class.getMethod("onRoomPulseEvent", RoomPulseEvent.class));
            this.methods.add(QuestEventListener.class.getMethod("onUserTalkEvent", UserTalkEvent.class));
            this.methods.add(QuestEventListener.class.getMethod("onUserPublishPictureEvent", UserPublishPictureEvent.class));
            ...
            this.methods.add(QuestEventListener.class.getMethod("onUserInviteFriendEvent", UserInviteFriendEvent.class));
            this.methods.add(QuestEventListener.class.getMethod("onUserFollowFriendEvent", UserFollowFriendEvent.class));
            this.methods.add(QuestEventListener.class.getMethod("onUserRelationShipEvent", UserRelationShipEvent.class));
            this.methods.add(QuestEventListener.class.getMethod("onUserTeleportEvent", UserTeleportEvent.class));
            this.methods.add(QuestEventListener.class.getMethod("onUserPetRespectEvent", UserPetRespectEvent.class));

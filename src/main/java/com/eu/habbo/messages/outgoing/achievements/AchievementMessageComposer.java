...
public class AchievementMessageComposer extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        ...
        this.response.appendString(this.achievement.getBadgeCode(targetLevel)); //Target badge code
        ...
        this.response.appendString(this.achievement.getCategory().getName().toLowerCase()); //Category

...
public class NavigatorFavoriteFilter extends NavigatorFilter {
    ...
    public List<SearchResultList> getResult(Habbo habbo) {
        ...
        resultLists.add(new SearchResultList(0, "favorites", "", SearchAction.NONE, habbo.getHabboStats().navigatorWindowSettings.getListModeForCategory("favorites", ListMode.LIST), habbo.getHabboStats().navigatorWindowSettings.getDisplayModeForCategory("favorites", DisplayMode.VISIBLE), rooms, true, true, DisplayOrder.ACTIVITY, -1));
        return resultLists;
    }
}

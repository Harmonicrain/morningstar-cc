...
public final class WiredAddonFurniNamePlaceholder extends InteractionWiredAddon {
  private String placeholder = "$", delimiter = "";
  private boolean multiple;

  public WiredAddonFurniNamePlaceholder(ResultSet s, Item i) throws SQLException {
    super(s, i);
  }

  public WiredAddonFurniNamePlaceholder(int id, int u, Item i, String e, int st, int se) {
    super(id, u, i, e, st, se);
  }

  @Override
  public WiredAddonType getType() {
    return WiredAddonType.FURNI_NAME_PLACEHOLDER;
  }
